    ...
    return (
        <nav className={`flex items-center justify-between fixed z-50 top-0 w-full px-6 md:px-16 lg:px-24 xl:px-32 py-4 ${openMobileMenu ? '' : 'backdrop-blur'}`}>
            ...
            <div className="flex items-center gap-4">
                <ThemeToggle />
                <button className="hidden md:block hover:bg-slate-100 dark:hover:bg-[#6A6DE9]/10 transition px-4 py-2 border border-[#6A6DE9] rounded-md">
                    Sign in
                </button>
                <button className="hidden md:block px-4 py-2 bg-[#6A6DE9] hover:bg-[#5B5ED8] transition text-white rounded-md">
                    Get started
                </button>
