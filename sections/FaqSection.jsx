...
export const FaqSection = () => {
    ...
    return (
        <div id="faq" className="relative max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
            ...
            <SectionTitle text1="FAQ's" text2="Frequently Asked Questions" text3="Everything you need to know about our AI automation services — from n8n workflows to voice agents." />
            <div className="mt-8">
                {faqsData.map((faq, index) => (
                    <div className="border-b border-slate-300 dark:border-[#6A6DE9]/30 py-4 cursor-pointer w-full" key={index} onClick={() => setOpenIndex(openIndex === index ? null : index)}>
